...
// Perulangan If Hitung Diskon

if((t_h >= 100000) && (t_h < 499999)) { // Diskon 30 %
...
cout<<"Kembalian Diskon Belanja		        = Rp. "<<kembali<<endl;
cout<<""<<endl;
...
}else if(t_h >= 500000) { // Diskon 50 %
cout<<"Selamat Anda Mendapat Diskon 50%"<<endl;
...
cut  = (t_h*0.5) + kembali;
cout<<"Cashback Sebesar 50%"<<endl;
cout<<"Total Kembali Belanja  		  		= Rp. "<<cut<<endl;
}else if(t_h < 100000){ // Harga Normal
t_h = j_b * harga; 										// perhitungan total harga
	cout<<"Total Harga 					  = Rp. "<<t_h<<endl;
